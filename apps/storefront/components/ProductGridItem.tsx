...
export const ProductGridItem: React.FC<ProductGridItemProps> = ({ product, settings, onAdd }) => {
        ...
        >
            ...
            <div className="aspect-square relative overflow-hidden bg-gray-50">
                ...
                <button
                    ...
                    className="absolute bottom-2 right-2 bg-orange-600 text-white p-2 rounded-full shadow-lg transform translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300"
                >
