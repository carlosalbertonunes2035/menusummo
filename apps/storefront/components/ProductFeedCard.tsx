...
const ProductFeedCard: React.FC<ProductFeedCardProps> = ({ product, settings, onAdd, onOpenComments }) => {
        ...
        <article className="bg-white border-b border-gray-100 md:border md:rounded-xl md:mb-8 md:shadow-sm pb-4 last:border-0">
                ...
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-yellow-400 to-pink-600 p-[1.5px]">
                        <div className="w-full h-full rounded-full bg-white p-[1.5px] overflow-hidden">
                            <img src={settings.logoUrl || "https://ui-avatars.com/api/?name=Loja"} className="w-full h-full rounded-full object-cover" alt="Logo" />
                        </div>
                    </div>
            ...
            <div onDoubleClick={handleLike} className="relative w-full aspect-[4/5] bg-gray-100 overflow-hidden">
                {isVideo ? (
                    ...
                    <img src={getProductImage(product)} className="w-full h-full object-cover" loading="lazy" alt={displayName} />
                )}
                ...
                <div className="absolute bottom-4 left-4 right-4 flex justify-start pointer-events-none">
                    <div
                    ...
                    >
                        <div className="bg-gray-100 rounded-md w-10 h-10 overflow-hidden flex-shrink-0">
                            <img src={getProductImage(product)} className="w-full h-full object-cover" alt={displayName} />
                        </div>
                        ...
                        <div className="bg-orange-600 text-white p-1.5 rounded-full ml-2">
                            <ShoppingBag size={14} />
                        </div>
                    </div>
                </div>
            ...
            <div className="px-4 pt-3">
                ...
                <button
                    onClick={onAdd}
                    className="w-full mt-4 bg-orange-600 text-white py-3 rounded-xl font-bold text-sm hover:bg-orange-700 transition flex items-center justify-center gap-2 active:scale-[0.98] shadow-lg"
                >
                    <ShoppingBag size={18} />
