        ...
        <header className="flex-none bg-summo-surface z-30 pt-safe relative shadow-sm border-b border-summo-border">
            <div className="px-4 py-3 flex justify-between items-center">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gray-100 overflow-hidden border border-summo-border">
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="bg-gray-100 p-2 rounded-lg border border-summo-border text-summo-text-muted hover:text-summo-primary transition"
                    ...
                    <button onClick={() => setIsDarkMode(!isDarkMode)} className="bg-gray-100 p-2 rounded-lg border border-summo-border text-summo-text-muted">
