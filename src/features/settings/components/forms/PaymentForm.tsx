...
export const PaymentForm: React.FC<SettingsFormProps> = ({ settings, onChange }) => (
    <div className={cardClass}>
        <div>
            <h4 className="font-bold mb-4 text-slate-800 dark:text-slate-100">Meios de Pagamento</h4>
            <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800 rounded-xl">
                    <span className="font-bold text-slate-700 dark:text-slate-200">Dinheiro</span>
                ...
                <div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800 rounded-xl">
                    <span className="font-bold text-slate-700 dark:text-slate-200">Pix</span>
                    <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div>
            <h4 className="font-bold mb-4 text-slate-800 dark:text-slate-100">Bandeiras de Cartão</h4>
            <div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800 rounded-xl mb-3">
                <span className="font-bold text-slate-700 dark:text-slate-200">Aceita Cartão (Débito/Crédito)</span>
                <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className={`grid grid-cols-2 sm:grid-cols-3 gap-2 ${!settings.payment.acceptCard ? 'opacity-50 pointer-events-none' : ''}`}>
                {Object.keys(settings.payment.brands || {}).map(brand => (
                    <label key={brand} className="flex items-center gap-2 p-2 bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-100 dark:border-slate-700 text-sm text-slate-700 dark:text-slate-200">
        ...
        <div>
            <h4 className="font-bold mb-4 text-slate-800 dark:text-slate-100">Vales Refeição/Alimentação</h4>
            <div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-slate-800 rounded-xl mb-3">
                <span className="font-bold text-slate-700 dark:text-slate-200">Aceita Vales</span>
                <label className="relative inline-flex items-center cursor-pointer">
