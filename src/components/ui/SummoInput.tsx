        ...
        <div className={`w-full ${className}`}>
            ...
            <div className="relative">
                ...
                <input
                    ...
                    id={inputId}
                    className={`
                        w-full rounded-xl bg-gray-50 dark:bg-gray-800 border 
                        ...
                        ${error
                            ...
                            : 'border-gray-200 dark:border-gray-700 focus:border-summo-primary focus:ring-2 focus:ring-summo-primary/20'
                        }
